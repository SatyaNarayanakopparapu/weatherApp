...
import com.app.weather.dto.WeatherAverageDTO;
import com.app.weather.dto.WeatherMapDTO;
import com.app.weather.dto.WeatherMapTimeDTO;
...
public class WeatherService {
    ...
    private String url(String city) {
        return String.format(URI.concat("?q=%s").concat("&appid=%s").concat("&cnt=30"), city, API_ID);
    }
}
